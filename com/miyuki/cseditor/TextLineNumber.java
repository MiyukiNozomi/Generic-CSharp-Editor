...
public class TextLineNumber extends JPanel implements CaretListener,
	...
	public HashMap<Integer,ImageIcon> warnings = new HashMap<Integer,ImageIcon>();
	...
	public TextLineNumber(JTextComponent component, int minimumDisplayDigits) {
		warnings = new HashMap<Integer,ImageIcon>();
		...
		while (rowStartOffset <= endOffset) {
			try {
				...
				if(!lineNumber.isEmpty()){
					ImageIcon pos = warnings.get(getLineNumber(rowStartOffset));
					if(pos != null){
						Image img = pos.getImage();
						g.drawImage(img, x - img.getWidth(null),y - img.getHeight(null) + 1,null);
					}
				}
